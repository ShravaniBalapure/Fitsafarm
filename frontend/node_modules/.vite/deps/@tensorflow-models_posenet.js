...
import {
  ...
  tidy,
  util_exports
} from "./chunk-R343E4R4.js";
import "./chunk-FEX4AVXX.js";
...
var extendStatics = function(e, t) {
  return (extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e2, t2) {
    ...
    for (var n in t2) t2.hasOwnProperty(n) && (e2[n] = t2[n]);
  })(e, t);
};
...
function __generator(e, t) {
  ...
  return i = { next: u(0), throw: u(1), return: u(2) }, "function" == typeof Symbol && (i[Symbol.iterator] = function() {
    return this;
  }), i;
  function u(i2) {
    return function(u2) {
      return function(i3) {
        ...
        for (; s; ) try {
          if (n = 1, r && (o = 2 & i3[0] ? r.return : i3[0] ? r.throw || ((o = r.return) && o.call(r), 0) : r.next) && !(o = o.call(r, i3[1])).done) return o;
          switch (r = 0, o && (i3 = [2 & i3[0], o.value]), i3[0]) {
            ...
            case 7:
              ...
              continue;
            default:
              if (!(o = (o = s.trys).length > 0 && o[o.length - 1]) && (6 === i3[0] || 2 === i3[0])) {
                s = 0;
                continue;
              }
...
var BaseModel = function() {
  ...
  return e.prototype.predict = function(e2) {
    ...
    return tidy(function() {
      var n = t.preprocessInput(cast(e2, "float32")), r = expandDims(n, 0), o = t.model.predict(r).map(function(e3) {
        return squeeze(e3, [0]);
      }), i = t.nameOutputResults(o);
      return { heatmapScores: sigmoid(i.heatmap), offsets: i.offsets, displacementFwd: i.displacementFwd, displacementBwd: i.displacementBwd };
    });
...
var MaxHeap = function() {
  ...
  return e.prototype.enqueue = function(e2) {
    ...
    for (; e2 > 0 && this.less(half(e2), e2); ) this.exchange(e2, half(e2)), e2 = half(e2);
  }, e.prototype.sink = function(e2) {
    for (; 2 * e2 <= this.numberOfElements; ) {
      var t = 2 * e2;
      if (t < this.numberOfElements && this.less(t, t + 1) && t++, !this.less(e2, t)) break;
...
function getStridedIndexNearPoint(e, t, n, r) {
  return { y: clamp(Math.round(e.y / t), 0, n - 1), x: clamp(Math.round(e.x / t), 0, r - 1) };
}
...
function argmax2d(e) {
  ...
  return tidy(function() {
    var t2 = reshape(e, [n * r, o]), i = argMax(t2, 0), s = expandDims(div(i, scalar(r, "int32")), 1), u = expandDims(mod(i, r), 1);
    return concat([s, u], 1);
  });
}
...
function mobileNetCheckpoint(e, t, n) {
  var r = { 1: "100", 0.75: "075", 0.5: "050" }, o = "model-stride" + e + ".json";
...
function getBoundingBox(e) {
  return e.reduce(function(e2, t) {
    var n = e2.maxX, r = e2.maxY, o = e2.minX, i = e2.minY, s = t.position, u = s.x, a = s.y;
    return { maxX: Math.max(n, u), maxY: Math.max(r, a), minX: Math.min(o, u), minY: Math.min(i, a) };
...
function getBoundingBoxPoints(e) {
  var t = getBoundingBox(e), n = t.minX, r = t.minY, o = t.maxX, i = t.maxY;
  return [{ x: n, y: r }, { x: o, y: r }, { x: o, y: i }, { x: n, y: i }];
}
...
function scalePose(e, t, n, r, o) {
  return void 0 === r && (r = 0), void 0 === o && (o = 0), { score: e.score, keypoints: e.keypoints.map(function(e2) {
    var i = e2.score, s = e2.part, u = e2.position;
    return { score: i, part: s, position: { x: u.x * n + o, y: u.y * t + r } };
  }) };
}
function scalePoses(e, t, n, r, o) {
  return void 0 === r && (r = 0), void 0 === o && (o = 0), 1 === n && 1 === t && 0 === r && 0 === o ? e : e.map(function(e2) {
...
function validateInputResolution(e) {
  util_exports.assert("number" == typeof e || "object" == typeof e, function() {
    return "Invalid inputResolution " + e + ". Should be a number or an object with width and height";
  }), "object" == typeof e && (util_exports.assert("number" == typeof e.width, function() {
    return "inputResolution.width has a value of " + e.width + " which is invalid; it must be a number";
  }), util_exports.assert("number" == typeof e.height, function() {
...
function assertValidOutputStride(e) {
  util_exports.assert("number" == typeof e, function() {
    return "outputStride is not a number";
  }), util_exports.assert(VALID_OUTPUT_STRIDES.indexOf(e) >= 0, function() {
...
function assertValidResolution(e, t) {
  util_exports.assert("number" == typeof e[0] && "number" == typeof e[1], function() {
    return "both resolution values must be a number but had values " + e;
  }), util_exports.assert(isValidInputResolution(e[0], t), function() {
    return "height of " + e[0] + " is invalid for output stride " + t + ".";
  }), util_exports.assert(isValidInputResolution(e[1], t), function() {
...
function toInputTensor(e) {
  return e instanceof Tensor ? e : browser_exports.fromPixels(e);
}
function padAndResizeTo(e, t) {
  ...
  return s / i < u ? (l = 0, p = 0, c = Math.round(0.5 * (u * i - s)), d = Math.round(0.5 * (u * i - s))) : (l = Math.round(0.5 * (1 / u * s - i)), p = Math.round(0.5 * (1 / u * s - i)), c = 0, d = 0), { resized: tidy(function() {
    var t2 = toInputTensor(e);
    return t2 = pad3d(t2, [[l, p], [c, d], [0, 0]]), image.resizeBilinear(t2, [n, r]);
  ...
  return e.prototype.estimateMultiplePoses = function(e2, t) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(n) {
        switch (n.label) {
          case 0:
            return "single-person" !== t.decodingMethod ? [3, 2] : [4, this.estimateSinglePose(e2, t)];
          case 1:
            return [2, [n.sent()]];
          case 2:
...
function loadMobileNet(e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(a) {
      switch (a.label) {
        case 0:
          if (t = e.outputStride, n = e.quantBytes, r = e.multiplier, null == dist_exports) throw new Error("Cannot find TensorFlow.js. If you are using a <script> tag, please also include @tensorflow/tfjs on the page before using this\n        model.");
...
function loadResNet(e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(u) {
      switch (u.label) {
        case 0:
          if (t = e.outputStride, n = e.quantBytes, null == dist_exports) throw new Error("Cannot find TensorFlow.js. If you are using a <script> tag, please also include @tensorflow/tfjs on the page before using this\n        model.");
...
@tensorflow-models/posenet/dist/posenet.esm.js:
  (**
      * @license
      ...
      *)
*/
//# sourceMappingURL=@tensorflow-models_posenet.js.map
